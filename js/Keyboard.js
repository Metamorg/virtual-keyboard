...
export default class Keyboard {
  ...
  init() {
    ...
    const description = createElement('p', 'description', null, null, 'Keyboard for Windows');
    const languageDescription = createElement('p', 'language', null, null, 'Switch language: left ctrl + alt');
